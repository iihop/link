...
<html>
    ...
    <body>
        ...
        <div class="signInContainer1">

            <div class="column">

                <div class="header">
                    <img src="assets/images/sng.png" title="Logo" alt="Site logo" />
                    <h3>PREMIUM REGISTER</h3>
        ...
        <button class="prem" onclick="window.location.href='http://localhost/link/register.php';">BASIC REGISTER</GET>
